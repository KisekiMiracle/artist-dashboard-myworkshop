    ...
    <Form {...form}>
      ...
      >
        ...
        <div className="flex items-center gap-2">
          <button className="bg-white border-[#e5e5e5] text-black btn">
            <svg
          ...
          <button className="bg-black border-black text-white btn">
            <svg
        ...
        <Link href="/auth/login" className="self-center mt-2 text-xs">
