    ...
    <KanbanColumnContext.Provider value={columnContext}>
      ...
      >
        <ColumnPrimitive
          ...
          style={composedStyle}
          className={cn(
            "flex flex-col gap-2 bg-zinc-100 dark:bg-zinc-900 aria-disabled:opacity-50 p-2.5 border rounded-lg size-full aria-disabled:pointer-events-none",
            {
